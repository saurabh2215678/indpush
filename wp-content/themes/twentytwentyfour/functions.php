...
// new codes
function initIndpushApi() {
    register_rest_route('signup', '/api', array(
        'methods' => array('GET', 'POST'),
        'callback' => 'signupAPI',
    ));
}
add_action('rest_api_init', 'initIndpushApi');

function signupAPI($request){
    if ($request->get_method() === 'GET') {
        ...
        if (isset($params['email'])) {
            $response_data = array('message' => 'success signup');
